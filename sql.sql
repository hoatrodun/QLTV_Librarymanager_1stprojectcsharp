...
GO
--DECLARE @SUCC INT 
--EXEC PROC_INSERT_ACCOUNT 'te','te',@SUCC OUTPUT
--SELECT STR(@SUCC, 10)
...
--EXEC DBO.PROC_UPDATE_BOOK 'S92492', N'LAP TRINH HUONG DOI TUONG', 'LAP TRINH HUONG DOI TUONG', 'LAP TRINH HUONG DOI TUONG ', 1, Null, 'STARTUP, YOUNG,'--
--select * from log order by TIME_CREATE
--END
...
--EXEC DBO.PROC_UPDATE_STUDENT 'S', N'S', 'S', 'S ', 1, Null, 'STARTUP, YOUNG,'--
...
GO
--exec PROC_INSERT_BORROW_DETAIL 57, 'S003', 2, '1/1/2000', 1, 'SDGAS'
go
